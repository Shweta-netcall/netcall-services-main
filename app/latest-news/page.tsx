  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="flex">
        ...
        <Link href="/latest-news" className="bg-purple-600 text-white py-4 px-6 hover:bg-purple-700 transition-colors">
          Latest News
        </Link>
      ...
      <div className="container mx-auto px-4 py-20">
        <h1 className="text-4xl font-bold text-teal-800 mb-10">Latest News</h1>
